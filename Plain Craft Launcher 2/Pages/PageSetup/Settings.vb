...
Public Class Settings
    ...
    Public Shared ReadOnly Entries As Dictionary(Of String, Setting) = (New List(Of Setting) From {
        ...
        New Setting("LaunchSkinType", 0, Source:=Sources.Registry),
        ...
        New Setting("LaunchRamType", 0),
        New Setting("LaunchRamCustom", 15),
        New Setting("DshNodePath", "", Source:=Sources.Registry),
        New Setting("DshPnpmPath", "", Source:=Sources.Registry),
        New Setting("DshInstallPath", "", Source:=Sources.Registry),
        New Setting("DshPort", 0, Source:=Sources.Registry),
        New Setting("DshModelMode", 1, Source:=Sources.Registry),
        New Setting("DshNpmMirror", 0, Source:=Sources.Registry),
        New Setting("DshProfile", "web", Source:=Sources.Registry),
        New Setting("DshExtraArgs", "", Source:=Sources.Registry),
        New Setting("DshBrowserType", 0, Source:=Sources.Registry),
        New Setting("DshBrowserPath", "", Source:=Sources.Registry),
        New Setting("DshBrowserArgs", "", Source:=Sources.Registry),
        New Setting("DshBrowserAutoOpen", True, Source:=Sources.Registry),
        New Setting("DshAutoStart", True, Source:=Sources.Registry),
        New Setting("DshStopOnExit", True, Source:=Sources.Registry),
        New Setting("DshUpdateChannel", 0, Source:=Sources.Registry),
        New Setting("DshDataRoot", "", Source:=Sources.Registry),
        New Setting("DshFirstRunDone", False, Source:=Sources.Registry),
        New Setting("DshPluginUseCdn", False, Source:=Sources.Registry),
